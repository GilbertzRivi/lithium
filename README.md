...
* **Per ratchet epoch:** every message carries a fresh ML-KEM encapsulation and a
  fresh ephemeral sender key, and receiver keys (RX) rotate with each peer reply and
