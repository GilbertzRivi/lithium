...
**Ochrona przed replay.** Zarejestrowany prawidłowy `WirePayload` może zostać ponownie przesłany do tego samego odbiorcy. AEAD zakończy się sukcesem. Wykrywanie replay leży po stronie mechanizmu numerów sekwencyjnych w `session.rs`.
